...
let subcheckYellow = document.querySelector('.subcheck__yellow'); 
...
window.addEventListener('click', function(event) {
    ...
    if (event.target.hasAttribute('data-yellow')) {           
        localStorage.setItem('counterY2', parseInt(subcheckYellow.innerText) + parseInt(yellow.innerText));
        subcheckYellow.innerText = parseInt(subcheckYellow.innerText) + parseInt(yellow.innerText);
        localStorage.setItem('counterR', parseInt(dataCheck.innerText) + 1);
        dataCheck.innerText = parseInt(dataCheck.innerText) + 1;
    } 
...
let counterY2 = localStorage.getItem('counterY2');///////////////////////
subcheckYellow.innerText = counterY2 ++;
